...
import { fetchLiveCurrencyRates } from "@/service/currency-convertor-services";
...
const currencyData: CurrencyProperties[] = [
...
const CurrencyConvertor = () => {
  ...
  //       fetchLiveCurrencyRates(currencyFrom, currencyTo);
  //     };
  ...
  const handleConvert = async () => {
    ...
    const responseData = await fetchLiveCurrencyRates(
      currencyFrom,
      currencyTo,
      amount
    );
    const convertedAmount: number = responseData?.conversion_result;
    setConvertedAmount(convertedAmount);
    console.log("Converted Amount", convertedAmount);
  };

  console.log("Updated Currency", currencyFrom, "->", currencyTo);

  return (
    <main className="size-full flex flex-col gap-4 p-4">
      <div className="w-fit">
      ...
      <div className="w-full flex flex-row gap-2">
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <Select onValueChange={(value) => setCurrencyFrom(value)}>
            ...
            <SelectContent>
              <SelectGroup>
                ...
                {currencyData?.map((currency: CurrencyProperties) => (
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <Select onValueChange={(value) => setCurrencyTo(value)}>
            <SelectTrigger className="w-[180px]">
              <SelectValue placeholder="Select Currency" />
            </SelectTrigger>
            <SelectContent>
      ...
      <div>
        <Button
          ...
          className="bg-amber-950 text-white cursor-pointer"
        >
          Convert
        </Button>
      </div>
